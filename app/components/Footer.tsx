    ...
    <footer className="relative bg-slate-100 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            <h3 className="text-xl font-medium font-poppins text-slate-800">
              İletişim
            </h3>
          </motion.div>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mb-8">
            <motion.a 
              href="mailto:hello@easychat.com.tr" 
              className="text-slate-600 hover:text-slate-800 transition-colors duration-200 font-poppins"
              whileHover={{ scale: 1.02 }}
            >
              hello@easychat.com.tr
            </motion.a>
            <motion.a 
